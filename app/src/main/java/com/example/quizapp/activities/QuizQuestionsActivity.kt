...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel =
            ViewModelProvider(this, QuestionVideModelFactory())[QuestionViewModel::class.java]
...
//        music = MediaPlayer.create(this@QuizQuestionsActivity, R.raw.second_sound)
        mediaPlayer = MediaPlayer.create(this@QuizQuestionsActivity, R.raw.second_sound)
//        mediaPlayer?.isLooping = true
//        mediaPlayer2 = MediaPlayer.create(this@QuizQuestionsActivity, R.raw.second_sound)
    ...
    private fun checkAnswer(selectedIndex: Int, correctAnswerIndex: Int) {
        if (isNewQuestion) {
            if (selectedIndex == correctAnswerIndex) {
                ...
                ) // Add 1 to convert back to 1-based index
                CORRECT += 1
                mediaPlayer = MediaPlayer.create(this, R.raw.correct_aswer)
                mediaPlayer?.start()
            } else {
...
//                        checkAnswer(0, correctAnswerIndex)
    ...
    // Function to stop the sound and start again
    fun stopAndRestart() {
//        mediaPlayer = MediaPlayer.create(this@QuizQuestionsActivity, R.raw.second_sound);
//        mediaPlayer?.let {
//            Log.d("MediaPlayer", "MediaPlayer state: ${if (it.isPlaying) "Playing" else "Not playing"}")
//            if (it.isPlaying) {
//                try {
//                    it.reset()
//                    it.prepare()
